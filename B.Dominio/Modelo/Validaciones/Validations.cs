...
namespace Modelo.Validaciones
{
    public class Validations
    {
        ...
        /// <summary>
        /// Validar que los nombres no tengan caracteres especiales.
        /// </summary>
        /// <param name="pNombre"></param>
        /// <returns></returns>
        public static Boolean ValidarNombres(object pNombre)
        {
            string nombre = pNombre.ToString().Replace(".", "");
        ...
        public static Boolean ValidateEnum<T>(T eEnumItem)
        {
            bool resp = System.Enum.IsDefined(typeof(T), eEnumItem);
            return resp;
        }
        ...
        public static Boolean ValidateLengthIgual(object entity, int maxLength)
        {
            if (entity == null) return true;
            if (entity.ToString().Length == maxLength) return true;
            return false;
        }
        ...
        public static Boolean ValidateMayorIgualZero(object entity)
        {
            if (entity == null) return false;
        ...
        public static Boolean ValidateMayorZero(object entity)
        {
            if (entity == null) return false;
        ...
        {
            if (entity == null) return false;
            return Util.IsDate(entity.ToString());
        }
        ...
        {
            if (entity == null) return false;
            if (Util.IsDate(entity.ToString()) == false) return false;
        ...
        /// <summary>
        /// Metodo para validar mayusculas
        /// </summary>
        /// <param name="enty"></param>
        /// <returns></returns>
        public static Boolean IsToUpper(object enty)
        {
            return Util.UppercasetLetter(enty.ToString());
        }
    }
}
